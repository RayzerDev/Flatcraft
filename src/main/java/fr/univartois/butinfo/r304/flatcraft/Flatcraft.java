...
import fr.univartois.butinfo.r304.flatcraft.model.map.SimpleCellFactory;
...
public final class Flatcraft extends Application {
    ...
    public void start(Stage stage) throws IOException {
        ...
        FlatcraftGame game = new FlatcraftGame(GAME_WIDTH, GAME_HEIGHT, new SpriteStore(), new SimpleCellFactory());
